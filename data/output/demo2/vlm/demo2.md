...
SHENG Wanxing, CHEN Jie, ZHENG Ge, SONG Xiaohui, GU Lingyun, LI L i shu
...
式中： $c_{\mathrm{DP}}(t)$  表示  $t$  时刻的 DP 值； $c_{\mathrm{DP}}(0)$  表示初始时刻的 DP 值； $k$  是一个常数。后来，他们对模型进行了改进，提出了二阶动力学模型，如式(3)所示，其中  $k_{10}$  和  $k_{2}$  均为常数。由此计算得出油纸绝缘寿命的表达式如式(4)所示，其中： $L$  表示油纸绝缘的寿命； $c_{\mathrm{DP}}(\mathrm{end})$  表示寿命终止时对应的 DP 值[22]。
...
![](images/9936e1672ab11f34106210d6fd76705cf26aaea5f26966f60ed797abb3901753.jpg)  
图10 常见绝缘缺陷对于椭圆曲线的影响  
