...
def _call_llm_polish_structure(raw_titles: str, full_context: str,api_key,base_url,model) -> str:
...
def get_markdown_titles_with_level(json_data_flat: List[Dict[str, Any]], full_context: str,api_key,base_url,model) -> List[str]:
    ...
    title_md_result = _call_llm_polish_structure(full_titles_input, full_context,api_key,base_url,model)
