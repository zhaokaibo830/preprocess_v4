...
def call_llm_polish_structure(raw_titles: str, full_context: str,api,url,model) -> str:
    """
    整理目录结构并标记层级。
...
def process_titles_with_llm(all_nodes: List[Dict[str, Any]], full_context: str,api,url,model) -> Dict[str, int]:
    ...
    title_md_result = call_llm_polish_structure(full_titles_input, full_context,api,url,model)
